...
public class MultiThreadReader {
    ...
    private MultiThreadReader(File file,IHandle handle,String charset,int bufferSize,int threadSize){
    ...
    public static class Builder{
        ...
        public MultiThreadReader build(){
            return new MultiThreadReader(this.file,this.handle,this.charset,this.bufferSize,this.threadSize);
        }
    }
